...
.Response fields
include::{snippets}/patch-existent-contact-name/response-fields.adoc[]

.Response links, contained in the __links_ section of the response
include::{snippets}/patch-existent-contact-name/links.adoc[]
...
.Response fields
include::{snippets}/patch-existent-contact-phone/response-fields.adoc[]
...
.Response fields
include::{snippets}/patch-existent-contact-name-and-phone/response-fields.adoc[]
